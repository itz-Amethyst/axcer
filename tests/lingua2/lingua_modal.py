...
app = modal.App("lingua2_evaluate_test")
# image_s = modal.Image.debian_slim(python_version="3.12").pip_install("selective_context", "spacy==3.7.0")
image_s = modal.Image.debian_slim(python_version="3.12").pip_install("llmlingua", "tiktoken")
...
def main(input_text: str):
    ...
    reduced_ctx = sc.compress_prompt_llmlingua2(input_text, rate=0.5)
    t1 = time.perf_counter()

    reduced_ctx = reduced_ctx["compressed_prompt"]
